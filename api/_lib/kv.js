...
if (process.env.UPSTASH_REDIS_REST_URL && process.env.UPSTASH_REDIS_REST_TOKEN) {
  try {
    ...
    console.error("Upstash init failed:", e?.message || e);
    kvClient = null;
    usingUpstash = false;
  }
}
...
// ===============================
// RAW STATE HELPERS (GLOBAL CONFIG)
// ===============================
...
async function _rawSet(key, value) {
  if (usingUpstash && kvClient) {
    try {
      await kvClient.set(key, value); // Upstash auto-serializes objects
      return true;
    } catch (e) {
...
export async function getState() {
  ...
  try {
    ...
    console.error("getState failed:", e?.message || e);
    return {};
  }
}
...
export async function setState(patch = {}) {
  ...
  try {
    ...
    console.error("setState failed:", e?.message || e);
...
// ===============================
// EXPORT RAW METHODS FOR hub.js
// ===============================

export { _rawGet, _rawSet };
